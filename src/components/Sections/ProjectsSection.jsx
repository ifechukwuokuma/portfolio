...
import { ArrowUpRight, Github, ArrowRight, X } from "lucide-react";
...
export const ProjectsSection = () => {
  ...
  const SkeletonLoader = () => (
    <div className="bg-gray-50 dark:bg-[#22242a] rounded-2xl shadow-sm overflow-hidden animate-pulse">
      <div className="h-64 bg-gray-300 dark:bg-gray-700"></div>
      <div className="p-6 text-left">
        <div className="w-1/3 h-5 bg-gray-300 dark:bg-gray-700 mb-3"></div>
      ...
      <div className="max-w-6xl mx-auto px-4 mb-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <a
            href="/projects"
            rel="noreferrer"
            className="bg-black dark:bg-white text-white dark:text-black px-6 py-3 rounded-full flex items-center gap-2 hover:bg-[#F9B233] dark:hover:bg-[#F9B233] dark:hover:text-black transition"
          >
